...
Participei de diversas competições de robótica trabalhando com visão computacional, automação e sistemas embarcados. Foi onde aprendi na prática a diferença entre código que *compila* e código que *funciona de verdade*.
...
Ainda estou descobrindo qual área me faz brilhar mais. Por enquanto, estou aperfeiçoando minhas habilidades em programação e construindo projetos que eu possa chamar de meus.
